...
def jsreg(request):
    ...
    js.save()
    log.save()
    msg='Registration is done Successful.'
...
def saveenq(request):
    ...
    enq.save()
    msg='Enquiry is Submitted Successfully.'
...
def emphome(request):
    objemp = Employer.objects.get(cpemailaddress=request.session['employer'])
    firmname = objemp.firmname
    return render(request, 'emphome.html', {'objemp': objemp})
...
def postjob(request):
    try:
        if request.session['employer']:
            objemp = Employer.objects.get(cpemailaddress=request.session['employer'])
            firmname = objemp.firmname
            return render(request, 'postjob.html', {'objemp': objemp})
    except:
...
def manageapp(request):
    try:
        if request.session['employer']:
            ...
            return render(request, 'manageapp.html', {'aj':aj, 'objemp':objemp})
    except:
        return render(request, 'login.html')
...
def empchangepassword(request):
    try:
        if request.session['employer']:
            objemp = Employer.objects.get(cpemailaddress=request.session['employer'])
            firmname = objemp.firmname
            return render(request, 'empchangepassword.html', {'objemp':objemp})
    except:
        return render(request, 'login.html')
...
def pjob(request):
    ...
    j.save()
    msg='Job is Posted Successfully.'
...
def empchangepwd(request):
    ...
    if newpassword!=confirmpassword:
        msg=msg+'New Password and Confirm Passord are not same !!!'
...
def applyjob(request):
    try:
        if request.session['jobseeker']:
            ...
            name=obj.name
            jb=Jobs.objects.all()
            return render(request, 'applyjob.html', {'jb':jb, 'obj': obj})
    except:
        return render(request, 'login.html')
...
def jobchangepwd(request):
    ...
    msg=''
    if newpassword!=confirmpassword:
        msg=msg+'New Password and Confirm Password are not same.'
    ...
    try:
        ...
        msg=msg+'Old Password does not matched.'
        return render(request, 'jobchangepassword.html', {'msg':msg})
...
def jsprofile(request, id):
    ...
    objemp = Employer.objects.get(cpemailaddress=request.session['employer'])
    firmname = objemp.firmname
    return render(request, 'jsprofile.html', {'obj': obj, 'objemp':objemp})
